...
- **模块管理**：维护项目内功能模块，用于任务的模块归属分类
- **版本管理**：管理项目发布版本，跟踪版本包含的任务与缺陷
